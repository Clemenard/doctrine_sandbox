...
/**
 * @ORM\Entity
 * @ORM\Table(name="microbit_projects")
 */
class ProjectMicroBit
{
    ...
    {
        if ($objectToCopyFrom instanceof ProjectMicroBit) {
            ...
            throw new EntityOperatorException("ObjectToCopyFrom attribute needs to be an instance of ProjectMicroBit");
        }
    }
